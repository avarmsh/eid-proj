    ...
    public static void update(int id, String field, String newValue, boolean isTaskId) {
        try{
            ...
            if(isTaskId){
                ...
                int oldTaskId = step.getTaskRef();
                step.setTaskRef(newTaskId);
                try{
                    ...
                    System.out.println("Couldn't change Task of Step.");
                    System.out.println(e.getMessage());
                }
            } else{
                ...
                try{
                    ...
                    System.out.println("Couldn't update step.");
                    System.out.println(e.getMessage());
                }
            }
        } catch(EntityNotFoundException e){
        ...
        try{
            ...
            if(option == 1){
                ...
                try{
                    ...
                    TaskService.checkTaskStatus(step.getTaskRef());
